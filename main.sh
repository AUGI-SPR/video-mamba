...
python main.py --dataset phakir --feature_extractor lovit_finetuned_fake --prior_knowledge ${prior_knowledge} --causal --action predict --num_decoders ${num_decoders} --low_penalty ${low_penalty} --high_penalty ${high_penalty}
