...
if args.mamba:
    addstr = "_mamba_dp%.2f_l%d_m%.2f_e%d" % (
        args.drop_path_rate,
        args.num_layers,
    ...
    addstr = "_transformer_dp0.30_l%d_m%.2f_e%d" % (
        args.num_layers,
        args.channel_mask_rate,
        args.num_epochs,
    )
...
num_f_maps = 256
features_dim = 768  ## LoViT features
bz = 1
...
vid_list_file = "/data2/local_datasets/" + args.dataset + "/videos/train"
vid_list_file_tst = "/data2/local_datasets/" + args.dataset + "/videos/test"
features_path = "/data2/local_datasets/" + args.dataset + "/features/"
gt_path = "/data2/local_datasets/" + args.dataset + "/groundtruth/"

mapping_file = "/data2/local_datasets/" + args.dataset + "/mapping.txt"

model_dir = "./{}/".format(args.model_dir) + args.dataset + addstr

results_dir = "./{}/".format(args.result_dir) + args.dataset + addstr
